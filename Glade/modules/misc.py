...
from Glade.utils import s_paste
...
async def deem(client: Client, message: Message):
    Glade = await edit_or_reply(message, "⚡ Usage:\n .dm @username Umm")
    quantity = 1
    ...
    if message.reply_to_message:
        ...
        for _ in range(quantity):
            await Glade.edit("Message Sended Successfully ✅")
            await client.send_message(
...
async def duckgo(client: Client, message: Message):
    ...
    if sample_url:
        ...
        await Glade.edit_text("something is wrong. please try again later.")
