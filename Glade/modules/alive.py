...
from Glade import CMD_HELP, StartTime
...
from Glade.helpers.tools import convert_to_image
from Glade.utils import get_readable_time
from Glade.utils.misc import restart
...
async def alive(client: Client, message: Message):
    ...
    try:
        ...
        await xx.edit(Glade, disable_web_page_preview=True)
...
async def setalivetext(client: Client, message: Message):
    ...
    await Glade.edit(f"**Berhasil Mengcustom ALIVE TEXT Menjadi** `{text}`")
    restart()
...
async def setemoji(client: Client, message: Message):
    ...
    await Glade.edit(f"**Berhasil Mengcustom EMOJI ALIVE Menjadi** {emoji}")
    restart()
