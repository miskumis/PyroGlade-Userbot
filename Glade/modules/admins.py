...
from Glade.helpers.adminHelpers import DEVS
from Glade.helpers.basic import edit_or_reply
from Glade.modules.help import add_command_help
from Glade.utils.misc import extract_user, extract_user_and_reason, list_admins
...
async def member_ban(client: Client, message: Message):
    ...
    if not bot.can_restrict_members:
        return await Glade.edit("I don't have enough permissions")
    if not user_id:
        return await Glade.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Glade.edit("I can't ban myself.")
    if user_id in DEVS:
        return await Glade.edit("I can't ban my developer!")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Glade.edit("I can't ban an admin, You know the rules, so do i.")
    try:
...
async def member_unban(client: Client, message: Message):
    ...
    if reply and reply.sender_chat and reply.sender_chat != message.chat.id:
        return await Glade.edit("You cannot unban a channel")
    ...
    await Glade.edit(f"Unbanned! {umention}")
...
async def mute(client: Client, message: Message):
    ...
    if not user_id:
        return await Glade.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Glade.edit("I can't mute myself.")
    if user_id in DEVS:
        return await Glade.edit("I can't mute my developer!")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Glade.edit("I can't mute an admin, You know the rules, so do i.")
    mention = (await client.get_users(user_id)).mention
    msg = (
...
async def unmute(client: Client, message: Message):
    ...
    await Glade.edit(f"Unmuted! {umention}")
...
async def kick_user(client: Client, message: Message):
    ...
    if not user_id:
        return await Glade.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Glade.edit("I can't kick myself.")
    if user_id == DEVS:
        return await Glade.edit("I can't kick my developer.")
    if user_id in (await list_admins(client, message.chat.id)):
        return await Glade.edit("I can't kick an admin, You know the rules, so do i.")
    mention = (await client.get_users(user_id)).mention
    msg = f"""
**Kicked User:** {mention}
**Kicked By:** {message.from_user.mention if message.from_user else 'Anon'}"""
    ...
    try:
        ...
        return await Glade.edit("**Maaf Anda Bukan admin**")
...
async def promotte(client: Client, message: Message):
    ...
    if message.command[0][0] == "f":
        ...
        return await Glade.edit(f"Fully Promoted! {umention}")
    ...
    await Glade.edit(f"Promoted! {umention}")
...
async def demote(client: Client, message: Message):
    ...
    if not user_id:
        return await Glade.edit("I can't find that user.")
    if user_id == client.me.id:
        return await Glade.edit("I can't demote myself.")
    await message.chat.promote_member(
        user_id,
        privileges=ChatPrivileges(
            can_Gladeage_chat=False,
    ...
    umention = (await client.get_users(user_id)).mention
    await Glade.edit(f"Demoted! {umention}")
